  ...
  return (
    <OnboardingContainer tracks={tracks}>
      ...
      <p className="instructions">
        The questions and replies that you post will automatically be tagged
        with the track you are in. If you are not in any cohort, choose None. If
        you are a career coach, choose I'm a career coach.
      </p>
      ...
      <button
        className="career-coach"
        onClick={() => props.history.push('/onboarding/careercoach')}
      >
        I'm a career coach<i className="fas fa-chevron-right"></i>
      </button>
