  ...
  return (
    <>
      ...
      <FAQContainer>
        ...
        <p className="answer">
          viewee is a platform that allows Lambda School students to answer,
          view, and post job interview questions to prepare for the real thing.
        </p>
        <p className="question">Why viewee?</p>
        <p className="answer">
          I felt there wasn't a platform who's sole purpose was about interview
          questions. Often it was tacked on to job and interview preparation
          sites and not really given much focus.
        </p>
        ...
        <p className="answer">
          ...
          viewing, answering, and posting questions.
        </p>
        ...
        <p className="answer">
          ...
          If the changes are satisfactory, I will merge!
        </p>
      </FAQContainer>
    </>
  );
