...
- **Step 5️⃣:** Pull down the main branch onto your branch. The easiest way to do this is to simply run `git pull origit branch gin main` **but make sure you're on your branch first** `git branch`.
