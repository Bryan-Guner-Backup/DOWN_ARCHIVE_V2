...
const recipientsRouter = require('./recipients/recipientsRouter');
...
app.use(['/api/recipient', '/api/recipients'], recipientsRouter);
app.use(['/api/location', '/api/locations'], locationsRouter);
